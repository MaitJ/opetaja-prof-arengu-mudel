...
CREATE TABLE `oppematerjal` (
  `oppematerjal_id` int NOT NULL AUTO_INCREMENT,
  `oppematerjal_nimi` varchar(100) NOT NULL,
  `oppematerjal_failinimi` varchar(250) NOT NULL,
  `profiil_id` int DEFAULT NULL,
  `oppematerjal_kirjeldus` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`oppematerjal_id`),
  KEY `profiil_id_idx` (`profiil_id`),
  CONSTRAINT `profiil_id` FOREIGN KEY (`profiil_id`) REFERENCES `profiil` (`profiil_id`)
...
INSERT INTO `oppematerjal` VALUES (1,'hulgateooria test 1','hulgateooria_test_1.pdf',NULL,NULL),(2,'lineaarsed võrrandid','linearequations.pdf',NULL,NULL),(12,'Lopetamiseasjad','file-1623661963339.pdf',8,'testest'),(13,'pilt','file-1623663923324.png',8,'pilt'),(14,'mp4','file-1623664076572.mp4',8,'mp4'),(15,'Poorlev kera','file-1623668435678.mp4',5,'Mingi suvaline netist leitud example fail funktsionaalsuse testimiseks.'),(16,'Lopetamise asjad','file-1623670943933.pdf',5,'Semestri lopetamise juhised, mis ajaks teatud asjad tehtud peavad olema');
...
CREATE TABLE `oppematerjal_profiil` (
  ...
  CONSTRAINT `Oppematerjal_profiil_Oppematerjal` FOREIGN KEY (`oppematerjal_id`) REFERENCES `oppematerjal` (`oppematerjal_id`),
...
INSERT INTO `profiil` VALUES (1,'Mait','Jurask',1,2,0,'',NULL,NULL),(2,'Martin','Kilgi',2,2,0,'',NULL,NULL),(3,'Test','Opetaja',3,1,0,'',NULL,NULL),(5,'Juhan','Jack',21,1,54936843,'Tallinn','profilepic-1623673313464','file-1623670943933.pdf'),(6,'Test','Kasutaja',22,1,54349867,'Tallinn',NULL,NULL),(7,'Yks','Test',23,1,53908765,'Tartu',NULL,NULL),(8,'veeltest','jep',24,1,9843843,'Tartu','profilepic-1623652657242','file-1623664076572.mp4');
...
-- Dump completed on 2021-06-15  9:38:54
