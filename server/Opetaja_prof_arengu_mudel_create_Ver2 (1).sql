...
-- Last modification date: 2021-06-09 12:16:02.05
...
CREATE TABLE KysimustePlokk_Tagasiside (
    ...
    Tagasiside_tagasiside_id int NOT NULL,
...
CREATE TABLE Tagasiside (
    ...
    KysimustePlokk_kysimusteplokk_id int NOT NULL,
...
ALTER TABLE KysimustePlokk_Tagasiside ADD CONSTRAINT KysimustePlokk_Tagasiside_Tagasiside FOREIGN KEY KysimustePlokk_Tagasiside_Tagasiside (Tagasiside_tagasiside_id)
...
ALTER TABLE Tagasiside ADD CONSTRAINT Tagasiside_KysimustePlokk FOREIGN KEY Tagasiside_KysimustePlokk (KysimustePlokk_kysimusteplokk_id)
    REFERENCES KysimustePlokk (kysimusteplokk_id);
